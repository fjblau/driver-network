...
async function pickupContainer(pickupContainer) {
    ...
    pickupContainer.container.transfer.push(pickupContainer.transfer)
    pickupContainer.container.portEntryCertificate.push(pickupContainer.portEntryCertificate)
